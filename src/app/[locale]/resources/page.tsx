          ...
          <div>
            ...
            <div className="space-y-3">
              {[ { k:"doc1" }, { k:"doc2" }, { k:"doc3" }, { k:"doc4" } ].map((d) => (
                <div key={d.k} className="p-4 bg-surface border border-border rounded-lg flex items-center justify-between group hover:border-primary/30 transition-colors">
                  <div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[ { k:"faq1" }, { k:"faq2" }, { k:"faq3" }, { k:"faq4" }, { k:"faq5" } ].map((f) => (
                <details key={f.k} className="p-4 bg-surface border border-border rounded-lg group">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[ { k:"post1" }, { k:"post2" }, { k:"post3" } ].map((p) => (
                <div key={p.k} className="p-4 bg-surface border border-border rounded-lg">
