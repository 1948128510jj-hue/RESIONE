export const SITE_CONFIG = {
  ...
  social: {
    ...
    linkedin: 'https://linkedin.com/company/godsaid3d',
    youtube: 'https://youtube.com/@resione3d',
    twitter: 'https://x.com/resione3d',
  },
  nav: [
    { label: 'Home', href: '/' },
...
export const WHY_CHOOSE_US = [
  ...
  },
  {
    ...
    description: 'Custom formulation, private labeling, and packaging solutions tailored to your brand requirements.',
    icon: '🏭',
  },
  {
...
export const OEM_SERVICES = [
  {
    ...
    description: 'We develop resins tailored to your specific requirements — color, viscosity, mechanical properties, and more.',
    icon: '🧪',
  },
  {
    title: 'Private Labeling',
    description: 'Your brand, our quality. Full white-label solutions with custom bottle design, labels, and packaging.',
    icon: '🏷️',
  },
  {
    title: 'Packaging Customization',
    description: 'Flexible packaging options from 500ml bottles to 25kg drums, with your branding throughout.',
    icon: '📦',
  },
  {
    title: 'Technical Documentation',
    description: 'We provide complete SDS, TDS, and print parameter guides in your language for your end customers.',
    icon: '📋',
  },
];
